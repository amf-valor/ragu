...
namespace Ragu.Tests
{
    ...
    public class CreateDeliveryLocaleTests : IAsyncLifetime
    {
        ...
        private class PostDeliveryLocaleRequest
        {
            ...
            internal static PostDeliveryLocaleRequest Any() 
                => new PostDeliveryLocaleRequest("any", 10.0m);

            internal static PostDeliveryLocaleRequest Bad() =>
                new PostDeliveryLocaleRequest("", 0.0m);
